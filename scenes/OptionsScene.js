class OptionsScene extends BaseMenuScene {
  init(options) {
    ...
    let tutorialButton = new MenuButton('factory')
    ...
    let playButton = new MenuButton('invite')
    playButton.position.set(0, 0, 0)
    playButton.onClick = () => {
      playButton.isEnabled = false
      Engine.switch(inviteScene)
    }
